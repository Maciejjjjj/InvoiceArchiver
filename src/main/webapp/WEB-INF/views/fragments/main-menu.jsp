...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: lightskyblue">
        ...
        <ul class="navbar-nav nav nav-pills nav-fill">
            <li class="nav-item active mx-1">
                <a class="nav-link btn btn-outline-info" role="button" href="/"><span
                        class="text-lg-left">Main page</span></a>
            </li>
    ...
    <sec:authorize access="!isAuthenticated()">
        <div style="margin-right: 20px">Welcome, <strong>stranger</strong></div>
    ...
    <sec:authorize access="isAuthenticated()">
        <div style="margin-right: 20px"> Welcome <strong>${pageContext.request.userPrincipal.principal.username}</strong></div>
